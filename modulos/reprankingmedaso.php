...
$TitCampos = "Asociacion,Oro,Plata,Bronce,4to Lugar,5to Lugar";
$NomCampos = "Asociacion,Oro,Plata,Bronce,4toLugar,5toLugar";
...
$QryPri = "
SELECT (SELECT Nombre FROM Asociaciones WHERE NRegistro = A.Asociacion) AS Asociacion,
