	...
	"Widgets" => array(
		"W0" => array(
			...
			"Apariencia" => array(
				...
				"Ancho" => "585px"//985px Es el Ancho maximo dentro de DivContenido				
			)			
		),
		"W1" => array(
			"ID" => "W1",
			"Titulo" => "Categorias Participantes",
			"Modo" => "Secundario",
			"Requerido" => "n",
			"Contenido" => array(
				"ID" => "W1",
				...
				"Campos" => "NRegCat,Estatus",
				"TitCam" => "Categorias,Estatus",				
			...
			"Apariencia" => array(
				...
				"PosInf" => "",
				"PosDer" => "",
				"PosIzq" => "835px",//245px minimo Para estar dentro de DivContenido
				"Alto" => "440px",
				"Ancho" => "395px",				
			)
		)
