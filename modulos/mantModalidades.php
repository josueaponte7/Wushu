...
$Cont["Campos"] = "NRegistro,Descripcion,Estatus";
$Cont["TitCam"] = "No,Descripcion,Estatus";
$Cont["Tabla"] = "modalidades";
$Cont["Donde"] = "";
	...
	"Widgets" => array(
		"W0" => array(
			...
			"Contenido" => array(
				...
				"Campos" => "Descripcion,Estatus",
				"TitCam" => "Descripcion,Estatus",
				"CmpReq" => "s,s,n,s,s,s,n,s",//Campos Requeridos
				"ValDef" => ",,,,,,,,,,",//Valores por defecto
				"CmpBlo" => "",//Campos bloqueados
				"CmpPas" => ",,,,,,,,,,",//Campos pass
				"CmpMxC" => ",,,,,,",//Maximo Caracteres
				"ValEsp" => "sollet",//Agregar tipoX en ValCam() de ../js/funcvari.js y mencionar aqui
