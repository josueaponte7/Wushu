...
$TitCampos = "Asociacion,Puntos";
$NomCampos = "Asociacion,Total";
...
$QryPri = "
SELECT (SELECT Nombre FROM Asociaciones WHERE NRegistro IN (SELECT Asociacion FROM atletas WHERE NRegistro = NRegAtl)) AS Asociacion,
	    SUM(Puntos) AS Total 
