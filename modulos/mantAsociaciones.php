...
$Cont["Campos"] = "NRegistro,Nombre,Telefono,EMail,Direccion,Representante,TelRep,EmailRep,Estatus";
$Cont["TitCam"] = "No,Nombre,Telefono,EMail,Direccion,Representante,Tel Rep,Email Rep,Estatus";
$Cont["Tabla"] = "asociaciones";
$Cont["Donde"] = "";
	...
	"Widgets" => array(
		"W0" => array(
			...
			"Contenido" => array(
				...
				"Campos" => "Nombre,Telefono,EMail,Direccion,Representante,TelRep,EmailRep,Estatus",
				"TitCam" => "Nombre,Telefono,EMail,Direccion,Representante,Tel Rep,Email Rep,Estatus",				
